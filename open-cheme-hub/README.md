...
| `awesome-chemical-engineering/` | 90 curated entries: process simulation, thermodynamics, reaction engineering, unit ops, optimisation, control, safety, CFD, data, courses |
...
| `awesome-bioengineering/` | 88 entries: bioprocess modelling, genome-scale metabolic models, synthetic biology, protein engineering, biomaterials, tissue engineering |
| `awesome-medical-engineering/` | 94 entries: device design, biomechanics, medical imaging, physiological signals, regulatory standards, health informatics |
| `awesome-general-engineering/` | 95 entries: CAD/CAE, control, signal processing, embedded and IoT, industrial protocols, reliability, documentation, ethics |
...
Around 460 curated entries in total, plus the runnable material.
...
4. **The list contents themselves.** These are a starting point built to be technically
   sound and honestly described, not a reference somebody has personally verified end to end.
   Before you point colleagues at a list, check the entries in your own field, click the links,
   and remove anything you wouldn't recommend in person. A curated list is worth exactly what
   its curator has actually checked — and once you publish, that curator is you.

---

## Verifying it before you publish
